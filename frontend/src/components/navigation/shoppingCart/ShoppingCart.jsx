...
function ShoppingCart({ cartClick, closeCart }) {
  ...
  return (
    <div className={"fixed z-50 top-0 w-22/25 h-screen bg-white transition-all duration-500 delay-50 md:w-1/2 lg:w-2/5 xl:w-1/3 "
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="w-full h-80 p-4 relative bottom-0 bg-white border-t border-gray-300 flex flex-col justify-between gap-4 overflow-scroll">
          {/* Free shipping info */}
